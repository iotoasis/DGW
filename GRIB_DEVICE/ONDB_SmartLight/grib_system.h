...
#define ATTR2STRING(x)                  x==FUNC_ATTR_USE_REPORT?"REPORT ONLY":     \
                                         x==FUNC_ATTR_USE_CONTROL?"CONTROL ONLY":   \
                                         x==FUNC_ATTR_USE_ALL?"REPORT & CONTROL":   \
                                         "INVALID FUNC ATTR"
...
int myBleMsg(GribFuncParam* pParam);
int myBleReset(void);
int myBleState(void);
int getBleAddr(GribFuncParam* pParam);
